...
parser.add_argument('--model', '-m', choices=['skipgram', 'cbow'], default='skipgram',
                    help='model type (skipgram, cbow)')
parser.add_argument('--out-type', '-o', choices=['hsm', 'ns', 'original'], default='hsm',
...
for epoch in range(args.epoch):
    ...
    S.save_hdf5("word2vec_chainer.model", model)
    print(accum_loss)
